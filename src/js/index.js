const Packager = require('@beyond-js/bundles-sdk/transversal/packager/code');
module.exports = class extends Packager {
	...
	constructor(tp, ...params) {
		...
		super.setup(new Map([['bundles', { child: new (require('./bundles'))(application, distribution) }]]));
	}
	...
	_generate() {
		...
		this.tp.application.engine === 'legacy' && sourcemap.concat('routing.setup(1);');
